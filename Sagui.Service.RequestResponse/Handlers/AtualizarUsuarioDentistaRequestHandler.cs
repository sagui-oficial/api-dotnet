        ...
        public async Task<ResponseUsuarioDentista> Handle(RequestUsuarioDentista Usuario)
        {
            ...
            if (errors.Count() == 0)
            {
                ...
                if (_Usuario != null)
                {
                    ...
                    responseUsuario.Message.Add(new Tuple<dynamic, dynamic, dynamic>(Constantes.MensagemAtualizada, nameof(responseUsuario.Dentinsta),
                                                                            String.Format(Constantes.MensagemListadaComSucesso, nameof(responseUsuario.Dentinsta))));
                ...
                else
                {
                    ...
                    responseUsuario.Message.Add(new Tuple<dynamic, dynamic, dynamic>(Constantes.ProblemaAoAtualizar, nameof(responseUsuario.Dentinsta),
                                                                           String.Format(Constantes.MensagemNaoAtualizado, nameof(responseUsuario.Dentinsta))));
                    return responseUsuario;
                }
            }
            else
